...
{ 
    ...
    public Lecturer(String subject,int classPerDay,String interviewerName,String className,double salary,int dailyWorkingHours)
    {
    ...
    public void lecturer(String lecturerName,String startingFrom,double advanceSalary,String academicBlockNumber)
    {
        if (joined==true)
        {
